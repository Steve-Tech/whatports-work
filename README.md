...
- Use telnet or similar command line tools, e.g. telnet whatports.work 1234
- Use curl or similar http clients, e.g. curl http://whatports.work:1234/raw
- Use nmap or similar port scanning tools, e.g. nmap -p 1234 whatports.work
